...
public class BlockAccountService {
    ...
    public GeneralResponseDTO execute(Long accountId) throws AccountException {
        ...
        baasIntegration.updateAccount(account.getExternalAccountNumber(), BLOCKED);

        accountRepository.save(account);

        postMessageService.executeAsync(createEventDTO(EventEnum.BLOCK_ACCOUNT, account.getId(), null));
